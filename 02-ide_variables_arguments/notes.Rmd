---
title: "熟悉 RStudio、Very Basic R (W2)"
date: '2019-09-26'
output:
  html_document:
    number_sections: no
...
1. Named and unnamed arguments assignment in a function (see [this](https://github.com/rlads2019/hw2/blob/master/index.Rmd))

1. Play with R (預備下週的 vector 介紹)
    1. Use **help page** to find: <code>?`:`</code>
    1. Play with sequence, use `sum()`, `mean()`
